...
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '비오내요~', '비오는데 등교하시는냐고 고생 하셨습니다.','hong')
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '안녕하세요~', '비오는데 등교하시는냐고 고생 하셨습니다.','an')
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '감사합니다.~', '비오는데 등교하시는냐고 고생 하셨습니다.','son')
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '수고하셨내요~', '비오는데 등교하시는냐고 고생 하셨습니다.','sejong')
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '화이팅하세요~', '비오는데 등교하시는냐고 고생 하셨습니다.','messi')
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '방갑습니다.~', '비오는데 등교하시는냐고 고생 하셨습니다.','jws' )
insert into BOARD (bno, btitle, bcontent, bwriter) values (member_seq.nextval, '미안합니다.~', '비오는데 등교하시는냐고 고생 하셨습니다.', 'kim')
